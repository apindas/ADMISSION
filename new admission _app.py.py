...
if selection == "New Admission":
    ...
    if st.sidebar.button("Export All Admission Data"):
        ...
        b64 = base64.b64encode(csv.encode()).decode()
        href = f'<a href="data:file/csv;base64,{b64}" download="all_admission_data.csv">Download Complete Admission Data</a>'
    ...
    if not st.session_state.students_df.empty:
        ...
        with analysis_tabs[4]:
            ...
            try:
                ...
                st.error(f"Error in date analysis: {e}")
                st.info("Make sure the date format is correct in your data.")
